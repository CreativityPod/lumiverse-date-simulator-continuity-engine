...
// Date Simulator Continuity Engine v1.4.6
...
const IMPORT_SETUP_PATTERN = /<!--DATE_SIM_IMPORT_SETUP_V1\s*-->/gi;
...
const SETUP_FORMAT = "date-simulator-initial-setup";
const MAX_SETUP_BYTES = 256 * 1024;
const IMPORT_LOADED_TEXT = "Saved setup loaded. Use Begin Simulation in the Continuity drawer, or type /begin to present the starting scene.";
const BEGIN_SETUP_TEXT = "/begin";

// Portable provenance names the baseline, never the source chat or its messages.
function assignSetupSources(value, sourceId) {
...
function validateSetupFile(input) {
  try {
...
function importedSetupForMessage(message) {
...
function isImportSetupSelection(messages) {
...
function initialSetupForBranch(store, turns, caseText) {
  const first = turns[0];
...
const DEFAULT_TRACKER_TIMEOUT_MS = 120_000;
const MIN_TRACKER_TIMEOUT_MS = 5_000;
const MAX_TRACKER_TIMEOUT_MS = 300_000;
const DEFAULT_TRACKER_MAX_TOKENS = 4_096;
const MIN_TRACKER_MAX_TOKENS = 400;
const MAX_TRACKER_MAX_TOKENS = 8_192;
